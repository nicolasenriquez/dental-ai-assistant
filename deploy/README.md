...
The real `.env` lives ONLY on the deploy host, in a directory owned by a dedicated deploy user with mode 600. It is never committed and never shared via chat.
