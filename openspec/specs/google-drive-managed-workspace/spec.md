...
- **WHEN** the user activates the header Drive control at desktop width
- **THEN** Assistant remains operable beside the keyboard-resizable Drive panel without backdrop
...
- **THEN** selection insertion is available without replacing `Insertar nota completa`
...
- **WHEN** managed editor patient does not equal active patient
