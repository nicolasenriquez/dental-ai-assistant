...
a PR touches these values it must be reviewed by a human — see the
Security-Sensitive Paths list in CLAUDE.md. A structural test asserts this
module's source contains no environment-variable lookups.
