...
The admin view is identified by a hardcoded user identifier, not by a role
system. The identifier comes from `ADMIN_USER_EMAIL` in the environment.

This file is auth-adjacent — it is the sole consumer of `get_current_admin`
outside tests. See the Security-Sensitive Paths list in CLAUDE.md; changes
here warrant careful human review.
"""
