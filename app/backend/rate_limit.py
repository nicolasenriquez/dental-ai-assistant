"""
Rate-limiter for the 25 messages / user / 24 hours cap (a hard security invariant).
...
remove, or make this value configurable must be reviewed by a human — see
the Security-Sensitive Paths list in CLAUDE.md.
