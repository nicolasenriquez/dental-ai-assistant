---
name: system-root-cause-analysis
description: Investigates a GitHub issue, identifies the root cause, and writes a structured RCA document for later implementation. Use when you need to diagnose a bug reported as a GitHub issue before fixing it.
...
Save analysis as: `docs/system-root-cause-analysis/issue-$ARGUMENTS.md`
...
This RCA document should be used by the `piv-implement-bugfix` skill.

## Next Steps

1. Review this RCA document
2. Run the `piv-implement-bugfix` skill with issue #$ARGUMENTS to implement the fix
