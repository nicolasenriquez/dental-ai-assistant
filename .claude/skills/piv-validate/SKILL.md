---
name: piv-validate
description: Runs comprehensive project validation — tests, type checks, linting, and a live server smoke test — and reports overall health. Use before committing or after finishing a chunk of work to confirm zero regressions.
---
...
**Expected:** All tests pass, fast execution time.
...
- Exact ports, the server entry point, and the tooling commands may differ per project — check
  `pyproject.toml`, `docker-compose.yml`, and the project README for project-specific values.
